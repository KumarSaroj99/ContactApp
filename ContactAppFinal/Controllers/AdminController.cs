...
namespace ContactAppFinal.Controllers
{
    ...
    {   
        ...
        public ActionResult Index()
        {
            ...
            {
                var newUser = User.Identity.Name;

                var data = session.Query<User>().Where(u => u.IsAdmin == false && u.UserName != newUser).ToList();
                return View(data);
            }
        ...
        public  ActionResult ViewAdmins()
        {
            ...
            {
                var newUser = User.Identity.Name;
                var data = session.Query<User>().Where(u => u.IsAdmin == true && u.UserName != newUser).ToList();
